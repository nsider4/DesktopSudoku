...
public class MenuBarHandler {
    ...
    private static MenuBar loadMenuBarItems(IUserInterfaceContract.View view) {
        ...
        item1.setOnAction(actionEvent -> {
            view.showDialog(Messages.NEW_GAME, Difficulty.EASY);
        });
        ...
        easyMenuItem.setOnAction( actionEvent -> {
            view.showDialog(Messages.CHANGE_DIFFICULTY_EASY, Difficulty.EASY);
        });
        mediumMenuItem.setOnAction( actionEvent -> {
            view.showDialog(Messages.CHANGE_DIFFICULTY_MEDIUM, Difficulty.MEDIUM);
        });
        hardMenuItem.setOnAction( actionEvent -> {
            view.showDialog(Messages.CHANGE_DIFFICULTY_HARD, Difficulty.HARD);
        });
        expertMenuItem.setOnAction( actionEvent -> {
            view.showDialog(Messages.CHANGE_DIFFICULTY_EXPERT, Difficulty.EXPERT);
        });
